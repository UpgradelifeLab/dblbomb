import requests, random, datetime, sys, time
import os
...
time.sleep(1)
os.system('cls||clear')
print("Послание от автора:")
print("Большая просьба заспамить до смерти этот номер:79037602680")
time.sleep(10)
print("Нажимите enter чтобы продолжить...")
input()
print(logo)
_phone = input('Привет! Введи номер, например:79037602680==> ')
if _phone[0] == '+':
	_phone = _phone[1:]
if _phone[0] == '8':
	_phone = '7'+_phone[1:]
